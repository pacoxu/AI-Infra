...
canonical_path: docs/archive-blog/2025-12-15/2025-12-15-multi-tenancy-isolation_zh.md
---

# AI Infra 时代的多租户隔离性方案探讨

[English Version](./2025-12-15-multi-tenancy-isolation.md)
...
![多集群管理雷达图 (CNCF + 生态项目)](../../../archive/mcm-radar/mcm-multicluster-radar.zh-CN.svg)

维护方式:

- 数据源: `archive/mcm-radar/mcm-multicluster-radar.data.json`
- 生成命令（同时产出英文/中文图）: `node archive/mcm-radar/scripts/generate-mcm-radar-svg.js`
