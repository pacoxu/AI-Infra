...
- **AMD:**
  - [MI300 Series](https://www.amd.com/en/products/accelerators/instinct/mi300.html)
...
**Note:** This document covers advanced pre-training techniques for
large-scale models. Content is based on recent research papers, technical
reports, and industry best practices. Please refer to official framework
